...
namespace LINQtoObject {
  internal class SampleData {
    ...
    public static Course[] Courses = {
      ...
      new Course { Name="Flash MX", Hours=45, Subject=Subjects[0], Department=Departments[1] },
      new Course { Name="Communication Skills", Hours=18, Subject=Subjects[1], Department=Departments[2] },
      new Course { Name="English", Hours=60, Subject=Subjects[2], Department=Departments[0] }
    };
  }
}
